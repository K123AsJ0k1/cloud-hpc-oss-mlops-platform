                    ...
                    if 0 < bucket_info['amount']:
                        ...
                        for object_path in submitter_bucket_objects:
                            if path_prefix in object_path:
                                # We will assume that the used index will
                                # utilize list to check for checked out cases
                                # We also assume that there is a garbage collector
                                # that handles the reduction of objects and
                                # in turn the checked set
