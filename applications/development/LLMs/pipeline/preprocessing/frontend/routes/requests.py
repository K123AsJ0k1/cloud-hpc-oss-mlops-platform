...
async def submit_job(
    ...
    # We assume that forwarders and submitters
    # are all given a ice id
    # We also assume that bucket prefixes are constant
...
async def submit_forwarding(
    ...
    # Consider separating this into imports and exports
