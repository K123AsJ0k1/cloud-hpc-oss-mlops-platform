...
from functions.utility.storage.files import create_file
...
def create_new_venv(
    ...
    # Refactor later to handle missing modules
    # We assume that it has been checked
    # that there is no venv with the same name
